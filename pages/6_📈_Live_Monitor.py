            ...
            try:
                ...
                for _, row in df.head(25).iterrows():
                    ...
                    if ip not in added_nodes:
                        dot.node(ip, ip, shape='ellipse', style='filled', fillcolor='#ff4b4b' if row['status'] >= 400 else '#3182bd', fontcolor='white')
                        added_nodes.add(ip)
                ...
                st.info("Hinweis: Stellen Sie sicher, dass 'graphviz' auch auf dem System (z.B. apt install graphviz) installiert ist.")
